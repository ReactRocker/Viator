...
import {validationSchema} from "./PaymentDetails.schema";
                ...
                {({errors, touched, isValid}) => (
                    <Form className="payment-form">
                        ...
                        <p className="terms-agreement">
                            By clicking 'Book Now', you agree to Viator's Customer Terms of Use and Privacy Statement,
                            plus the third party operator's terms & conditions. Viator, Inc. facilitates your booking,
                            but the operator provides the experience directly to you.
                        </p>
                        ...
                        <div className="button-group">
                            ...
                            <div className="button-group-right">
                                <button type="submit" className="btn-primary" disabled={!isValid}>Book Now</button>
                            </div>
                        </div>
                    </Form>
                )}
