...
const ContactDetails = ({ onNext }) => {
  ...
  const initialValues = isLoggedIn ? userInfo : {
    firstName: '',
    lastName: '',
    email: '',
    phoneNumber: '',
    ...
    <div className="contact-details">
      ...
      <div className="contact-form">
        ...
        <div className="flex-grow">
          ...
          {!isLoggedIn && mode === 'create' && (
            <p className="guest-info mb-4">By continuing, we will create an Account for you throughout the booking process.</p>
          )}
            ...
            {({ errors, touched, isSubmitting }) => (
              <Form className="form-layout">
                <div className="form-row">
                  <div className={`input-group ${errors.firstName && touched.firstName ? 'error' : ''}`}>
                  ...
                  <div className={`input-group ${errors.lastName && touched.lastName ? 'error' : ''}`}>
                ...
                <div className="form-row">
                  ...
                  <div className={`input-group ${errors.phoneNumber && touched.phoneNumber ? 'error' : ''}`}>
