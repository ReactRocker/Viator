...
import {validationSchema} from "./ActivityDetails.shema";
                        ...
                        return ((
                            <Form>
                                ...
                                <div className="meeting-point">
                                    ...
                                    <p className="meeting-point-description">Please choose where you prefer to meet for
                                        your
                                        experience. If you're not sure, you can decide later.</p>
                                ...
                                <div className="form-row">
                                    <div className="input-group">
                                        ...
                                        />
                                        {errors.tourLanguage && touched.tourLanguage &&
                                            <div className="error">{errors.tourLanguage}</div>}
                                    </div>
                                    <div className="input-group">
                                        ...
                                        {errors.specialRequirements && touched.specialRequirements &&
                                            <div className="error">{errors.specialRequirements}</div>}
                                    </div>
                                </div>

                                <div className="button-group">
                                    <div className="button-group-left">
                                        <button type="button" onClick={onPrev} className="btn-secondary">Previous
                                        </button>
                                    </div>
                                    <div className="button-group-right">
                                        <button type="submit" className="btn-primary" disabled={!isValid}>Next</button>
                                    </div>
                                </div>
                            </Form>
                        ))
